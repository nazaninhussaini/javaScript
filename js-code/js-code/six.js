...
//Array with method join example with string
...
name.pop();
name.push("mozghan");
//Array with method some example with string
const some_every = name.some((names)=>{
    return names.includes("a")

})
//object with string proprty : to lower case 
const students = [
    {
        id:1,
        name : "nazanin",
